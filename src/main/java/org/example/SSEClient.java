...
public class SSEClient {
    ...
    @Builder
    public SSEClient(String url, Map<String, String> headerParams, EventHandler eventHandler, String username,
    ...
    private void handleResponse(InputStream inputStream) throws IOException {
        ...
        try (BufferedInputStream in = IOUtils.buffer(inputStream)) {
            try (BufferedReader reader = new BufferedReader(new InputStreamReader(in, StandardCharsets.UTF_8))) {
                ...
                long lastReceivedMessageTime = startTime;
                while((line = reader.readLine()) != null && (lastReceivedMessageTime - startTime <  this.streamEndTime*1000)) {
                ...
                if(lastReceivedMessageTime - startTime > this.streamEndTime*1000){
...
//        pool.execute(()-> {
//            Timer t = new Timer();
//            TimeOutTask timeOutTask = new TimeOutTask(thread, t);
//            t.schedule(timeOutTask, 10000);
//        });
    }
